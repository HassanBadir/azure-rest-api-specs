...
namespace Microsoft.Azure.Commands.Sql.ThreatDetection.Services
{
    ...
    public class SqlThreatDetectionAdapter
    {
        ...
        public ServerThreatDetectionPolicyModel GetServerThreatDetectionPolicy(string resourceGroup, string serverName)
        {
            ...
            var DA = threatDetectionPolicy.DisabledAlerts.Where(alert => !string.IsNullOrEmpty(alert)).ToArray();
            serverThreatDetectionPolicyModel.ExcludedDetectionTypes = DA == null ? new string[] { } : DA;
        ...
        {  
            ...
            var DA = threatDetectionProperties.DisabledAlerts.Split(';').Where(alert => !string.IsNullOrEmpty(alert)).ToArray();
            model.ExcludedDetectionTypes = DA == null ? new string[] { } : DA;
